...
public class PacketHandler {
    ...
    public void handlePacket(DatagramPacket packet) {
        ...
        if (packetType == PacketType.USER_GET_JWT.getIndex()) {
            ...
            HashMap<String, PropHuntPlayer> players = new HashMap<>();
            ...
            for (Map.Entry<String, PropHuntPlayer> player : players.entrySet()) {
            ...
            if (updateType == PacketType.UPDATE_LOCATION.getIndex()) {

            } else if (updateType == PacketType.UPDATE_PROP.getIndex()) {

            } else if (updateType == PacketType.UPDATE_TEAM.getIndex()) {

            } else if (updateType == PacketType.UPDATE_STATUS.getIndex()) {
